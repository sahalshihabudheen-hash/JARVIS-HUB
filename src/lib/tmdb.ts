...
export const getUserLocation = async (): Promise<{ country: string; country_name: string; region: string; languages: string }> => {
  try {
    ...
    return { country: "US", country_name: "United States", region: "", languages: "en-US" };
  }
};
